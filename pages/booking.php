												...
												<div class="row">
													<div class="col-lg-12">
														<div class="form-group">
															...
															<div class="col-lg-4">
																<input class="form-control" name="fname1" required="required" pattern="[A-Za-z]+$">
															</div>
															<div class="col-lg-2">
															...
															<div class="col-lg-4">
																<input class="form-control" name="mname1">
															</div>
														</div>
														<br><br>
														...
														<div class="form-group">
															...
															<div class="col-lg-4">
																<input class="form-control" name="lname1" pattern="[A-Za-z]+$">
															</div>
															<div class="col-lg-2">
																<label>Age</label>
															</div>
														...
														<div class="form-group">
															...
															<div class="col-lg-4">
																<input class="form-control" name="ocp1" pattern="[A-Za-z]+$" >
															</div>
															<div class="col-lg-2">
																<label>PAN</label>
															</div>
														...
														<div class="form-group">
															...
															<div class="col-lg-4">
																<input class="form-control" type="number" name="mobno1">
															</div>
														</div>
														<br><br>
														<div class="form-group">
														...
														<div class="form-group">
															...
															<div class="col-lg-4">
																<textarea class="form-control" rows="3" name="padd1" id="padd1" ></textarea>
															</div>
														</div>
													</div>
												</div>
