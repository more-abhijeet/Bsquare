...
<body>
    ...
    <div id="wrapper">
     ...
     <?php include('leftbar.php')?>;
      ...
      <td><?php echo htmlentities(strtoupper($res->interestedIn));?></td>
      ...
      <a href="bookingofenquiryuser.php?id=<?php echo htmlentities($res->id);?>"  data-toggle="tooltip" title="payment">
	  <p class="fa fa-share"></p></a>
	  </td>
