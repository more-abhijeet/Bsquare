                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <?php
									 ...
									 ?>
                                        <tr class="odd gradeX">
                              <td><?php echo $sn?></td>
             <td><?php echo htmlentities(strtoupper($res->fname1." ".$res->mname1." ".$res->lname1));?></td>
       <td><?php echo htmlentities(strtoupper($res->email1));?></td>
	  <td><?php echo htmlentities($res->mobno1);?></td>
      <td><?php echo htmlentities(strtoupper($res->config));?></td>
      <td>&nbsp;&nbsp;
